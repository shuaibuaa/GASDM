...
public class RG_TestForPrediction {
	public static String[] prov_vector={"北京","天津","河北","河南","山西","山东","内蒙","辽宁","吉林","黑龙","陕西","湖北","湖南","安徽","江苏","甘肃","宁夏","四川","重庆","江西","浙江","上海","新疆","西藏","云南","广西","广东","青海","福建","贵州","海南","香港","澳门","台湾"};
	...
	public static void main(String[] args) throws Exception {
		...
		int[] indicatorVector= new int[prov_vector.length];
		int dayCount=0;
		ArrayList<String> dayList=readLines("data/dengue/days_count.txt",0);
		BufferedWriter outputWriter = null;
		outputWriter = new BufferedWriter(new FileWriter("data/dengue/result.txt"));
